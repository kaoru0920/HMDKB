...
static keyb_t US_L = { "US_L",L"1234567890QWERTYUIOPASDFGHJKL@ZXCVBNM:;!",10,4,
    ...
    {{VK_SHIFT,'A',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'S',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'D',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'F',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'G',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'H',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'J',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'K',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'L',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,VK_OEM_3,VK_SHIFT},{1,0,0},3},
    {{VK_SHIFT,'Z',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'X',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'C',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'V',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'B',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'N',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'M',VK_SHIFT},{1,0,0},3},{{VK_SHIFT,VK_OEM_1,VK_SHIFT},{1,0,0},3},{{VK_SHIFT,VK_OEM_PLUS,VK_SHIFT},{1,0,0},3},{{VK_SHIFT,'1',VK_SHIFT},{1,0,0},3},1}
};
